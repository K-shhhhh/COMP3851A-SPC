...
Notes:	Changed every relationship rules to restrict for testing purposes, basically NO DELETION IS ALLOWED.
*/
...
create table if not exists knowledge_nodes (
	...
	references knowledge_graphs(graph_id)	on delete restrict
);
...
create table if not exists knowledge_edges (
	...
	references knowledge_nodes(node_id)	on delete restrict,
...
create table if not exists ai_response_sources (
	...
	references ai_responses(response_id)	on delete restrict,
	...
	references knowledge_edges(edge_id)	on delete restrict
);
